...
class ActivityCoursePage extends StatefulWidget {
  final String url = "http://class-path-content.herokuapp.com/activities/";

  @override
  ActivityCoursePageState createState() {
    return ActivityCoursePageState();
  }
}

class ActivityCoursePageState extends State<ActivityCoursePage> {
